...
export function TopBar({ title, subtitle, actions }: TopBarProps) {
  ...
  return (
    <div className="flex flex-wrap sm:flex-nowrap items-start sm:items-center justify-between gap-2 px-4 sm:px-6 py-3 sm:py-4 border-b border-brand-border sticky top-0 z-20 bg-brand-dark/95 backdrop-blur-sm print:hidden">
      ...
      <div className="flex items-center gap-2 shrink-0 flex-wrap justify-end w-full sm:w-auto">
        <div
          className="hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-head border"
          style={
            useApi
