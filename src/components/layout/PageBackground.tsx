    ...
    <div className="relative flex-1 flex flex-col min-h-0">
      {image && (
        <>
          ...
          />
          {/* Gradient: stronger at top, fades to content */}
          <div
          ...
          />
          {/* Left-edge orange accent — use explicit pixel width, not w-px, to survive retina */}
          <div
            className="absolute inset-y-0 left-0 pointer-events-none"
            style={{ width: 2, background: 'linear-gradient(to bottom, transparent 0%, rgba(255,107,0,0.4) 30%, rgba(255,107,0,0.4) 70%, transparent 100%)' }}
          />
        </>
      )}
