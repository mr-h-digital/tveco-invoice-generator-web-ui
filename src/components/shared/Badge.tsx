...
const CONFIG: Record<BadgeStatus, { label: string; className: string }> = {
  ...
  ACCEPTED: { label: 'Accepted', className: 'bg-emerald-500/15 text-emerald-400 border border-emerald-500/30' },
  REJECTED: { label: 'Rejected', className: 'bg-red-500/15 text-red-400 border border-red-500/30' },
  EXPIRED: { label: 'Expired', className: 'bg-slate-500/15 text-slate-300 border border-slate-500/30' },
};
