...
export function LoginPage() {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 100, display: 'flex', alignItems: 'center', justifyContent: 'center', background: C.night, overflow: 'hidden' }}>
      ...
      {/* Dark overlay with orange tint on the left */}
      ...
      {/* Corner accents */}
      <motion.div initial={{ scaleX: 0 }} animate={{ scaleX: 1 }} transition={{ delay: 0.10, duration: 0.45 }} style={{ position: 'absolute', top: 28, left: 28, width: 40, height: 2, background: C.orange, borderRadius: 2, transformOrigin: 'left' }} />
      <motion.div initial={{ scaleY: 0 }} animate={{ scaleY: 1 }} transition={{ delay: 0.10, duration: 0.45 }} style={{ position: 'absolute', top: 28, left: 28, width: 2, height: 40, background: C.orange, borderRadius: 2, transformOrigin: 'top' }} />
      ...
      <motion.div initial={{ scaleX: 0 }} animate={{ scaleX: 1 }} transition={{ delay: 0.20, duration: 0.45 }} style={{ position: 'absolute', bottom: 28, left: 28, width: 40, height: 2, background: C.orange, borderRadius: 2, transformOrigin: 'left' }} />
      <motion.div initial={{ scaleY: 0 }} animate={{ scaleY: 1 }} transition={{ delay: 0.20, duration: 0.45 }} style={{ position: 'absolute', bottom: 28, left: 28, width: 2, height: 40, background: C.orange, borderRadius: 2, transformOrigin: 'bottom' }} />
        ...
        >
          <div style={{ background: 'rgba(17,19,24,0.95)', border: `1px solid ${C.border}`, borderRadius: 16, padding: '40px 40px 36px', backdropFilter: 'blur(20px)', boxShadow: `0 32px 80px rgba(0,0,0,0.7), 0 0 0 1px rgba(255,107,0,0.06)` }}>
            ...
            >
              ...
              <AnimatePresence>
                {error && (
                  <motion.div initial={{ opacity: 0, y: -6, height: 0 }} animate={{ opacity: 1, y: 0, height: 'auto' }} exit={{ opacity: 0, y: -4, height: 0 }} transition={{ duration: 0.2 }}
                    style={{ display: 'flex', alignItems: 'center', gap: 8, color: '#EF4444', fontFamily: "'Outfit', sans-serif", fontSize: 13 }}>
            ...
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.65, duration: 0.4 }}
              ...
              Access your export inquiries, quotes, documents, and milestone updates.
            </motion.p>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.75, duration: 0.4 }}
              style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 20, paddingTop: 16, borderTop: `1px solid ${C.border}` }}>
